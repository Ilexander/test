  ...
  <div class="auth-inner row m-0">
    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        ...
        @endif
        <form class="auth-register-form mt-2" action="{{route('auth.create',['language' => Config::get('app.locale')])}}" method="POST">
          @csrf
          <div class="mb-1">
          ...
          <div class="mb-1">
            ...
            <input class="form-control" id="register-username" type="text" name="first_name" placeholder="johndoe" aria-describedby="register-username" autofocus="" tabindex="1" />
          </div>

          <div class="mb-1">
            <label class="form-label" for="register-username">Last name</label>
            <input class="form-control" id="register-username" type="text" name="last_name" placeholder="johndoe" aria-describedby="register-username" autofocus="" tabindex="1" />
          </div>
          ...
          <div class="mb-1 bootstrap-select" style="margin-bottom: 15px;">
        ...
        <p class="text-center mt-2">
          ...
          <a href="{{route('auth.login',['language' => Config::get('app.locale')])}}"><span>&nbsp;Sign in instead</span></a>
        </p>
      </div>
    </div>
    <!-- /Register-->
